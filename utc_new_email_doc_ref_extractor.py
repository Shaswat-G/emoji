# -----------------------------------------------------------------------------
# Script: utc_new_email_doc_ref_extractor.py
# Summary: Extracts emoji characters, Unicode points, emoji shortcodes, and
#          document references from UTC email bodies, outputting an enriched
#          Excel file for downstream analysis.
# Inputs:  utc_email_with_llm_extraction.xlsx (parsed UTC emails)
# Outputs: utc_email_with_llm_extraction_output.xlsx (enriched with extractions)
